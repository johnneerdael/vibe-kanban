...
<Note>
The configuration page displays the exact file path where your settings are stored (typically within the `/data` volume). Vibe Kanban saves only your overrides whilst preserving built-in defaults.
</Note>

...
1. **Git Worktree Creation**: An isolated environment is created for this task attempt inside the container's `/repos` directory.
2. **Setup Scripts Run**: Any setup script defined in your project settings runs automatically within the container environment.

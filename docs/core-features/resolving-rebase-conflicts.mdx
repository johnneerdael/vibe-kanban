...
<Step title="Continue the rebase">
  ...
  ```bash
  docker compose exec vibe-kanban git add .
  docker compose exec vibe-kanban git rebase --continue
  ```
</Step>
</Steps>
...
```bash
docker compose exec vibe-kanban git rebase <last-commit-before-your-work> --onto <new-base>
```
...
docker compose exec vibe-kanban git rebase 64d504c94d076070d17affd3f84be63b34515445 --onto main
```

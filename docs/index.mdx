...
Vibe Kanban is an **orchestration platform for AI coding agents** that helps developers plan, review, and safely execute AI-assisted coding tasks. This branch is optimized for **Docker-only deployment**, ensuring a consistent and isolated environment for your AI agents.
...
<CardGroup cols={2}>
  <Card title="Docker Installation" icon="docker" href="/getting-started">
    Quickly deploy Vibe Kanban using Docker Compose
  </Card>

  <Card title="Supported Agents" icon="robot" href="/supported-coding-agents">
    Configure Claude Code, Gemini, and other AI assistants
  </Card>
</CardGroup>

...
<Check>
These changes update the global configuration file of the coding agent. Since Vibe Kanban runs in Docker, ensure any custom server files are placed in a volume-mapped directory like `/data` to be accessible.
</Check>
</Step>
</Steps>

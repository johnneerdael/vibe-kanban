...
<Step title="Launch IDE integration">
  Click the **"Open in VSCode"**, **"Open in Cursor"**, or **"Open in Windsurf"** button.

  <Note>
  If you are running Vibe Kanban in Docker, ensure you have configured **Remote SSH** in [Global Settings](/configuration-customisation/global-settings#remote-ssh-configuration) to allow your local IDE to connect to the container's files.
  </Note>
</Step>
